          ...
          >
            ...
            >
              <motion.div
                ...
                className="mb-8"
              >
                <h1 className="text-5xl sm:text-6xl md:text-7xl font-display font-bold mb-8 leading-tight text-black">
                  Discover Trends 
                  <br />
                  That Matter
                </h1>
                <p className="text-lg sm:text-xl md:text-2xl mb-12 max-w-3xl mx-auto text-gray-600 leading-relaxed">
